<template>
    <div class="p-4 sm:p-6 max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 border border-gray-100">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex gap-2">
                    <button @click="showGradeSettingsModal = true" 
                            class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors">
                        <i class="fa fa-cog mr-2"></i>Grade Settings
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 border border-gray-100">
            <h3 class="text-lg font-semibold mb-4 text-gray-800">Computation Parameters</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Academic Session</label>
                    <select v-model="computationParams.session_id" @change="loadStudents" 
                ...
                <div>
                    ...
                    <select v-model="computationParams.level_id" @change="loadStudents" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <select v-model="computationParams.programme_id" @change="loadStudents" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <select v-model="computationParams.semester" @change="loadStudents" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="mt-6 flex gap-4">
                <button @click="computeAllResults" :disabled="!canCompute || computing" 
                        class="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 disabled:opacity-50 transition-colors">
                    <i v-if="computing" class="fa fa-spinner fa-spin mr-2"></i>
                    <i v-else class="fa fa-calculator mr-2"></i>
                    {{ computing ? 'Computing...' : 'Compute All Results' }}
                </button>
                
                <button @click="previewComputation" :disabled="!canCompute" 
                        class="bg-green-500 text-white px-6 py-2 rounded-lg hover:bg-green-600 disabled:opacity-50 transition-colors">
                    <i class="fa fa-eye mr-2"></i>Preview Computation
                </button>
                
                <button @click="exportComputationReport" :disabled="students.length === 0" 
                        class="bg-purple-500 text-white px-6 py-2 rounded-lg hover:bg-purple-600 disabled:opacity-50 transition-colors">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Current GPA</th>
