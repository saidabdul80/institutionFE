<template>
    <div class="p-4 sm:p-6 max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 border border-gray-100">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex gap-2">
                    <button @click="showComputationModal = true" 
                            class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors">
                        <i class="fa fa-calculator mr-2"></i>Compute Results
                    </button>
        ...
        <!-- Filter Section -->
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 border border-gray-100">
            <h3 class="text-lg font-semibold mb-4 text-gray-800">Filter Results</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Session</label>
                    <select v-model="filters.session_id" @change="loadResults" 
                ...
                <div>
                    ...
                    <select v-model="filters.level_id" @change="loadResults" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <select v-model="filters.programme_id" @change="loadResults" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <select v-model="filters.semester" @change="loadResults" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl p-4 sm:p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xl sm:text-2xl lg:text-3xl font-bold">{{ resultStats.totalStudents || 0 }}</p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-xl p-4 sm:p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xl sm:text-2xl lg:text-3xl font-bold">{{ resultStats.resultsComputed || 0 }}</p>
                    </div>
                    <div class="bg-white/20 rounded-full p-3">
            ...
            <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 text-white rounded-xl p-4 sm:p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xl sm:text-2xl lg:text-3xl font-bold">{{ resultStats.pendingResults || 0 }}</p>
                    </div>
                    <div class="bg-white/20 rounded-full p-3">
            ...
            <div class="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-xl p-4 sm:p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xl sm:text-2xl lg:text-3xl font-bold">{{ (resultStats.averageGPA || 0).toFixed(2) }}</p>
                    </div>
                    <div class="bg-white/20 rounded-full p-3">
                        ...
                        <tr v-for="result in paginatedResults" :key="result.id" class="hover:bg-gray-50">
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <img v-if="result.student.picture" :src="result.student.picture" 
                                             class="h-10 w-10 rounded-full object-cover" :alt="result.student.first_name">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex gap-2">
                                    ...
                                    <button @click="editResult(result)" 
        ...
        <!-- Bulk Upload Modal -->
        <Dialog v-model:visible="showBulkUploadModal" modal header="Bulk Upload Results" :style="{width: '500px'}">
            <div class="p-4">
                <div class="mb-4">
