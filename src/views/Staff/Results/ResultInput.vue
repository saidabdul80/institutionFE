        ...
        <div class="max-w-7xl mx-auto space-y-6">
                ...
                <template #content>
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <Button @click="saveAllResults" :disabled="!hasUnsavedChanges" icon="pi pi-save"
                                label="Save All" class="p-button-primary" size="small" />
                        </div>
                    </div>
                </template>
            </Card>
            ...
            <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 border border-gray-100">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    <div v-for="grade in gradeScale" :key="grade.grade" class="text-center p-3 bg-gray-50 rounded-lg">
