export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            // Link Button
            { 'text-sky-600 bg-transparent border-transparent': props.link },
            ...
            // sky Button
            {
                ...
                'bg-sky-500 dark:bg-sky-400': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
                'border border-sky-500 dark:border-sky-400': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain
            },
            // sky Text Button
            { 'text-sky-500 dark:text-sky-400': props.text && props.severity === null && !props.plain },
            // sky Outlined Button
            { 'text-sky-500 border border-sky-500 hover:bg-sky-300/20': props.outlined && props.severity === null && !props.plain },
            ...
            // Info Button
            {
                ...
                'bg-sky-500 dark:bg-sky-400': props.severity === 'info' && !props.text && !props.outlined && !props.plain,
                'border border-sky-500 dark:border-sky-400': props.severity === 'info' && !props.text && !props.outlined && !props.plain
            },
            // Info Text Button
            { 'text-sky-500 dark:text-sky-400': props.text && props.severity === 'info' && !props.plain },
            // Info Outlined Button
            { 'text-sky-500 border border-sky-500 hover:bg-sky-300/20 ': props.outlined && props.severity === 'info' && !props.plain },
            ...
            // Link
            { 'focus:ring-sky-400/50 dark:focus:ring-sky-300/50': props.link },
            ...
            // sky
            { 'hover:bg-sky-600 dark:hover:bg-sky-300 hover:border-sky-600 dark:hover:border-sky-300': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain },
            { 'focus:ring-sky-400/50 dark:focus:ring-sky-300/50': props.severity === null },
            // Text & Outlined Button
            { 'hover:bg-sky-300/20': (props.text || props.outlined) && props.severity === null && !props.plain },
            ...
            // Info
            { 'hover:bg-sky-600 dark:hover:bg-sky-300 hover:border-sky-600 dark:hover:border-sky-300': props.severity === 'info' && !props.text && !props.outlined && !props.plain },
            { 'focus:ring-sky-400/50 dark:focus:ring-sky-300/50': props.severity === 'info' },
            // Text & Outlined Button
            { 'hover:bg-sky-300/20': (props.text || props.outlined) && props.severity === 'info' && !props.plain },
