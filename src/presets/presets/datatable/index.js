export default {
    ...
    thead: ({ context }) => ({
        class: [
            {
                'bg-surface-50 top-0 z-[40] bg-white sticky': context.scrollable
            }
        ]
    }),
    tbody: ({ instance, context }) => ({
        class: [
            {
                'sticky z-[20] bg-white': instance.frozenRow && context.scrollable
            }
        ]
    }),
    tfoot: ({ context }) => ({
    ...
    column: {
        headercell: ({ context, props }) => ({
            class: [
                ...
                // Position
                { 'sticky z-[20] bg-white border-b ': props.frozen || props.frozen === '' },
                ...
                {
                    'overflow-hidden space-nowrap border-b bg-clip-padding': context.resizable // Resizable
                }
            ]
        }),
        headercontent: {
            class: 'flex items-center headertitle',            
        },
        sort: ({ context }) => ({
        ...
        bodycell: ({ props, context, state, parent }) => ({
            class: [
                //Position
                { 'sticky bg-white z-[10] box-border border-b': parent.instance.frozenRow },
                { 'sticky bg-white z-[10] box-border border-b': props.frozen || props.frozen === '' },
    ...
    rowgroupheader: {
        class: ['sticky z-[20] bg-white ', 'bg-surface-0 text-surface-600 dark:text-white/70', 'dark:bg-surface-800']
    },
    rowgroupfooter: {
        class: ['sticky z-[20] bg-white', 'bg-surface-0 text-surface-600 dark:text-white/70', 'dark:bg-surface-800']
    },
