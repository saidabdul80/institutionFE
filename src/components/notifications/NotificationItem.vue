      ...
      <div class="p-4">
        <div class="flex items-start">
          ...
          <div class="flex-1 w-0 ml-3 text-left">
            <p
              :class="`text-sm  font-bold my-0 ${
                success ? 'text-gray-900' : info ? 'text-sky-900 ' : warning ? 'text-amber-950' : 'text-red-800'
              }`"
            >
              {{
                notification.title
            ...
            <p
              :class="`mt-1 text-sm leading-5 ${
                success ? 'text-gray-500' : info ? 'text-sky-800 mb-0' : warning ? 'text-amber-500' : 'text-red-700'
              }`"
            >
              {{
          ...
          <div class="flex shrink-0">
            <button
              :class="
                success ? 'text-gray-400 focus:text-gray-500' :
                info ? 'text-blue-400 focus:text-blue-500' :
                warning ? 'text-amber-400 focus:text-amber-500' :
